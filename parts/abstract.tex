...
\resumo{Resumo}{
	...
	apenas uma pequena parcela das saídas envolvidos na representação da informação é ativada, e a abordagem variacional que assume modelos probabilísticos para aprender representações latentes.
